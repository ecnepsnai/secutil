...
func TestHashingSHA256(t *testing.T) {
	t.Parallel()

	expected := "f52fbd32b2b3b86ff88ef6c490628285f482af15ddcb29541f94bcf526a3f6c7"
	result := secutil.Hashing.SHA_256.HashString("hunter2")
...
func TestHashingSHA512(t *testing.T) {
	t.Parallel()
	...
	result := secutil.Hashing.SHA_512.HashString("hunter2")
...
func TestHashingSHA512Null(t *testing.T) {
	t.Parallel()
	...
	result := secutil.Hashing.SHA_512.Hash([]byte{})
