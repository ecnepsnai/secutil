...
The developers of secutil aim to make security a priority for the project. This document describes our policy for handling
security vulnerabilities within the secutil software.

## Supported Versions

Only the most recent release of secutil is supported. Older versions are not supported and may contain unfixed security
vulnerabilities.
...
We do not run a bug bounty program and do not offer monetary rewards. secutil is an open source project with absolutely no
